			...
			<div className="flex items-center gap-2 px-3 py-2.5 bg-white border-b border-gray-100">
				...
				<div className="flex-1 flex items-center bg-gray-100 rounded-full px-4 py-2.5">
					...
					<input
						type="text"
						placeholder=""
						className="bg-transparent outline-none text-[14px] text-black w-full"
						readOnly
					/>
				</div>
			...
			<div className="flex-1 bg-white overflow-y-auto">
				<div className="px-4 pt-5 pb-4">
					...
					{data.items.map((item, i) => (
						<div key={`item-${i.toString()}`} className="flex gap-3 mb-4">
							<img
								src={item.productImage}
								alt="Product"
								className="w-[100px] h-[100px] rounded-lg flex-shrink-0 object-cover bg-gray-50"
							/>
					...
					<div className="text-right mb-5">
						<p className="text-[15px] font-bold text-black">Total for {totalQuantity} items: US ${data.totalPrice}</p>
					</div>
